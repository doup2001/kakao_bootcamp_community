...
public enum ErrorCode {
    ...
    INVALID_REFRESH_TOKEN(401_004, HttpStatus.UNAUTHORIZED, "재발급 토큰이 유효하지 않습니다."),
    INVALID_ACCESS_TOKEN(401_005, HttpStatus.UNAUTHORIZED, "접근 토큰이 유효하지 않습니다."),
    INVALID_TOKEN(401_006, HttpStatus.UNAUTHORIZED, "토큰이 생성되지 않았습니다."),
    INVALID_LOGIN(401_007, HttpStatus.UNAUTHORIZED, "로그인이 필요합니다."),
